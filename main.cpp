...
#include<stdio.h>
#include<stdlib.h>
#include<GL/glut.h> //Header file include
#include<math.h>

//this is the library functions that i have used  in this project
...
void introScreen()
{
	...
	displayRasterText(-100, 150, 0.0,"created by");
		glColor3f(1.0, 1.0, 1.0);
	 displayRasterText(-120, 80, 0.0,"Sharmin Begum");
	 	glColor3f(1.0, 0.0, 0.0);
	  displayRasterText(-800, -100, 0.0," STUDENT ID & BATCH");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," ID. 181-115-106");
	displayRasterText(-800, -285, 0.0," Batch. 44th-C");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Project Submitted to");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Masum Ahmed Eesha");
	displayRasterText(500, -285, 0.0,"Lecturer,DEPARTMENT OF CSE");
		glColor3f(1.0, 0.0, 0.0);
...
void passiveMotionFunc(int x,int y) {
	...
	mouseX = float(x)/(m_viewport[2]/1200.0)-600.0;  //converting screen resolution to ortho 2d spece
...
int main(int argc, char **argv)
{
	...
	glutInitDisplayMode(GLUT_SINGLE|GLUT_RGB);//the initial display mode
    glutInitWindowPosition(0, 0);
    glutInitWindowSize(1200, 600);//Specifies the initial window width and height, in pixels.
    glutCreateWindow("Space Shooter");//creates a window with the given title
    init();
    ...
    glutMainLoop();//the infinite event-processing loop
}
